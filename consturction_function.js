...
console.log(g1);   
// CardName1 { name: 'Jack', phone: '0985', hello: [Function: greet] }
// 函式包含在物件內 
console.log(g2);  
// CardName1 { name: 'Kevin', phone: '0977', hello: [Function: greet] }
// 函式包含在物件內 
console.log(g3);  
// CardName1 { name: 'Jennifer', phone: '0911', hello: [Function: greet] }
// 函式包含在物件內 
